...
SET fic=_%date:~6,4%%date:~3,2%%date:~0,2%_%vheure%%vmin%%vsec%.dump
 ...
 md C:\Users\jean-Noel-11\Documents\bdd_batch\adn_l49\%DATE:/=-%
 ...
 SET BACKUP_FILE1=C:\Users\jean-Noel-11\Documents\bdd_batch\adn_l49\%DATE:/=-%\%db1%_%datestr%.sql
 ...
 psql.exe -h production.metis-map.fr -p 5432 -U postgres -d adn_l49 -c "CREATE DATABASE adn_l49;" -f C:\Users\jean-Noel-11\Documents\bdd_batch\adn_l49\%DATE:/=-%\%db1%_%datestr%.sql
