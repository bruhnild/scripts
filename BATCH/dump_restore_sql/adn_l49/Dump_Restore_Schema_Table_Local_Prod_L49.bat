...
pg_dump.exe -h 192.168.101.254 -p 5432 -U postgres -v -f C:\Users\jean-Noel-11\Documents\bdd_batch\adn_l49\rip2.sql -n rip2  adn_l49
...
psql.exe -h production.metis-map.fr -p 5432 -U postgres -d adn_l49 -c "DROP SCHEMA IF EXISTS rip2 CASCADE;" 
psql.exe -h production.metis-map.fr -p 5432 -U postgres -d adn_l49 -c "CREATE SCHEMA rip2;" -f C:\Users\jean-Noel-11\Documents\bdd_batch\adn_l49\rip2.sql
