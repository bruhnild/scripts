...
and (
    	phase_prog like 'Conquête' 
    or phase_prog like 'Engagement' 
    or phase_prog like 'Equilibre' 
    or phase_prog like 'Volume' 
    or phase_prog IS NULL
    )
...
DROP TABLE IF EXISTS coordination.numerisation_priorite_2018_v2;
CREATE TABLE coordination.numerisation_priorite_2018_v2 as
...
ALTER TABLE coordination.numerisation_priorite_2018_v2 DROP COLUMN id RESTRICT;
CREATE INDEX numerisation_priorite_2018_v2_gix ON coordination.numerisation_priorite_2018_v2 USING GIST (geom);
