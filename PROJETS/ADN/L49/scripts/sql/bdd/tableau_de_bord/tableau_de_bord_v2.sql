...
DROP TRIGGER IF EXISTS trg_update_t_suivi_opp ON dashboard.t_suivi;
DROP TRIGGER IF EXISTS trg_update_t_suivi_opp ON coordination.opportunite;
CREATE TRIGGER trg_update_t_suivi_opp
AFTER UPDATE OR INSERT ON coordination.opportunite
FOR EACH ROW
EXECUTE PROCEDURE update_t_suivi();
...
DROP TRIGGER IF EXISTS trg_delete_duplicate_rows_v_num_opp_synthese ON dashboard.v_num_opp_synthese;
CREATE TRIGGER trg_delete_duplicate_rows_v_num_opp_synthese
INSTEAD OF INSERT OR UPDATE ON dashboard.v_num_opp_synthese
FOR EACH ROW EXECUTE PROCEDURE delete_duplicate_rows_v_num_opp_synthese();
