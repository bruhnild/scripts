...
psql.exe -h www.metis-reseaux.fr -p 5678 -U postgres -d l49  -f I:\14-ADN\04-Scripts\rapport_bi_mensuel\bat\opportunites_synthese.sql -t
psql.exe -h www.metis-reseaux.fr -p 5678 -U postgres -d l49  -f I:\14-ADN\04-Scripts\rapport_bi_mensuel\bat\opportunites_typegc.sql -t
