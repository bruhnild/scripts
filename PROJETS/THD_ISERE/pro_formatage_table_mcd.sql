...
Voir Annexe SIG : I:\13 - AXIANS\THD ISERE\02 - Réception données client\Axians\05_06_2017\Données d'entrée tr20_in\01_01_SIG_DOCUMENT_GENERAL_V2_201608.pdf
Voir NOMMAGE_DES_OBJETS_DANS_QGIS : I:\13 - AXIANS\THD ISERE\02 - Réception données\Axians\tr20_in - TR21\PRO\23_08_2017\POCHE_tr20_in
-------------------------------------------------------------------------------------
*/
...
-- Insertion dans la table metis_livrable.cable les entités de tr20_in.cable
...
-- Insertion dans la table metis_livrable.bpe les entités de tr20_in.bpe
...
-- Insertion dans la table metis_livrable.lgfourreaux les entités de tr20_in.lgfourreaux
...
ALTER TABLE metis_livrable.lgautre
  ...
  -- Insertion dans la table metis_livrable.lgautre les entités de tr20_in.lgautre
...
-- Insertion dans la table metis_livrable.lgorange les entités de tr20_in.lgorange
...
ALTER TABLE metis_livrable.tranchee
  ...
  -- Insertion dans la table metis_livrable.tranchee les entités de tr20_in.tranchee
...
ALTER TABLE metis_livrable.trace
  ...
  -- Insertion dans la table metis_livrable.trace les entités de tr20_in.trace
...
ALTER TABLE metis_livrable.ptchambre
  ...
  -- Insertion dans la table metis_livrable.ptchambre les entités de tr20_in.ptchambre
...
-- Insertion dans la table metis_livrable.zone les entités de tr20_in.zone
...
-- Insertion dans la table metis_livrable.ssc_tr les entités de tr20_in.ssc_tr
...
-- Insertion dans la table metis_livrable.sds_tr les entités de tr20_in.sds_tr
...
-- Insertion dans la table metis_livrable.pi les entités de tr20_in.pi
...
-- Insertion dans la table metis_livrable.photo les entités de tr20_in.photo
...
-- Insertion dans la table metis_livrable.pdc_pdinterco_pdl les entités de tr20_in.pdc_pdinterco_pdl
...
from tr20_in.pdc_pdinterco_pdl
;
...
-- Insertion dans la table metis_livrable.nro les entités de tr20_in.nro
...
-- Insertion dans la table metis_livrable.zde les entités de tr20_in.zde
...
drop table if exists metis_livrable.count_fourreaux;
create table metis_livrable.count_fourreaux as 
...
FROM 
    ...
    FROM metis_livrable.lgfourreaux
    GROUP BY geom
    ) as f
JOIN
    metis_livrable.tranchee t
ON t.geom = f.geom