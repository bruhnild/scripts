...
(
	...
	SELECT 
		...
		, b.digt_7
		, '00'
		, to_char(a.gid, 'FM00000')) AS cb_code --   /!\ ALTER TABLE avp_n070gay.cable_linestring ADD COLUMN gid SERIAL PRIMARY KEY;
		, cb_capa
	FROM avp_n070gay.cable_linestring a,psd_orange.zanro_hsn_polygon_2154 b
		...
		(
			...
			(
				...
				FROM 
					...
					, avp_n070gay.cable_linestring c 
