...
(SELECT ad_code FROM 
(WITH ad_nom_ld_ban_liaisonvoie AS
((SELECT ad_code, ad_ban_id, nom_ld FROM
(WITH ad_ban_id_liaison AS
(SELECT 
	DISTINCT ON (ad_code) a.ad_code,
...
) SELECT * FROM ad_nom_ld_ban_liaisonvoie)a))a)
...
(SELECT ad_code FROM 
(WITH ad_nom_ld_ban_liaisonvoie_majic AS 
((SELECT ad_code, ad_ban_id, nom_ld FROM
(WITH ad_ban_id_liaison AS
(SELECT 
	DISTINCT ON (ad_code) a.ad_code,
...
SELECT * FROM ad_nom_ld_ban_liaisonvoie_majic)a))	
...
-----------------NOM LIEU DIT AVEC VOIE MAJIC (SANS BAN/GEO_LIEUDIT)
UNION ALL
-----------------NOM LIEU DIT AVEC VOIE MAJIC (SANS BAN/GEO_LIEUDIT) 
...
-----------------NOM LIEU DIT AVEC VOIE SANS PCI (SANS BAN/GEO_LIEUDIT/VOIE MAJIC)
UNION ALL
-----------------NOM LIEU DIT AVEC VOIE SANS PCI (SANS BAN/GEO_LIEUDIT/VOIE MAJIC) 
