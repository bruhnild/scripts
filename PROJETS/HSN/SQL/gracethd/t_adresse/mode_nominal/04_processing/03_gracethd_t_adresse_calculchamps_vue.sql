...
--- Schema : rbal
--- Vue : v_bal_columns_gracethdview
--- Traitement : Crée la vue v_bal_columns_gracethdview à partir de jointures (cf I:\20-MOE70-HSN\07-Scripts\SQL\gracethd\t_adresse\mode_nominal\vues)

-- CREATE OR REPLACE VIEW rbal.v_bal_columns_gracethdview AS
