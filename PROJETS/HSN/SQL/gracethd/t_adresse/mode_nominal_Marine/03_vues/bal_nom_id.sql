...
Objet : Création de la vue v_bal_nom_id pour calculer le champ nom_id
Modification : Nom : ///// - Date : date_de_modif - Motif/nature : //////

Sources: rbal.liaison_hsn_linestring_2154(id_locaux) via psd_orange.locaux_hsn_sian_zanro_point_2154 (id)
-------------------------------------------------------------------------------------
*/
