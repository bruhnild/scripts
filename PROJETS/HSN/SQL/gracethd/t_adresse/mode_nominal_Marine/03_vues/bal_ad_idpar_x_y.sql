...
Objet : Création de la vue v_bal_ad_idpar_x_y pour calculer les champs ad_idpar, ad_x_parc et ad_y_parc
Modification : Nom : ///// - Date : date_de_modif - Motif/nature : //////

Sources: pci70_edigeo_majic.geo_parcelle (geo_parcelle/x geom/y geom)
-------------------------------------------------------------------------------------
*/
