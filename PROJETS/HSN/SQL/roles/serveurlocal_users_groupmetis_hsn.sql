...
GRANT CONNECT ON DATABASE hsn TO acalba;
/*Actions permises par les utilisateur*/
GRANT SELECT ON ALL TABLES IN SCHEMA ban TO acalba;
GRANT SELECT ON ALL TABLES IN SCHEMA pci70_edigeo_majic TO acalba;
GRANT SELECT ON ALL TABLES IN SCHEMA pci70_etalab TO acalba;
GRANT SELECT ON ALL TABLES IN SCHEMA enedis TO acalba;
GRANT SELECT ON ALL TABLES IN SCHEMA orange TO acalba;
GRANT SELECT ON ALL TABLES IN SCHEMA psd_orange TO acalba;
GRANT SELECT ON ALL TABLES IN SCHEMA rbal TO acalba;
GRANT SELECT ON ALL TABLES IN SCHEMA reseau_hsn TO acalba;
GRANT SELECT ON ALL TABLES IN SCHEMA gracethd TO acalba;
GRANT SELECT ON ALL TABLES IN SCHEMA gracethd_metis TO acalba;
GRANT SELECT ON ALL TABLES IN SCHEMA gracethdcheck TO acalba;
GRANT SELECT ON ALL TABLES IN SCHEMA gracethdcheckpub TO acalba;
GRANT SELECT ON ALL TABLES IN SCHEMA sirene TO acalba;
GRANT SELECT ON ALL TABLES IN SCHEMA zone_abf TO acalba;
GRANT SELECT ON ALL TABLES IN SCHEMA zone_azi TO acalba;
GRANT SELECT ON ALL TABLES IN SCHEMA topology TO acalba;
GRANT SELECT ON ALL TABLES IN SCHEMA public TO acalba;
GRANT SELECT ON ALL TABLES IN SCHEMA osm TO acalba;
GRANT SELECT ON ALL TABLES IN SCHEMA la_poste TO acalba; 
GRANT SELECT ON ALL TABLES IN SCHEMA pci70_majic_analyses TO acalba;
GRANT INSERT,SELECT,UPDATE,DELETE ON ALL TABLES IN SCHEMA ban TO acalba;
GRANT INSERT,SELECT,UPDATE,DELETE ON ALL TABLES IN SCHEMA psd_orange TO acalba;
GRANT INSERT,SELECT,UPDATE,DELETE ON ALL TABLES IN SCHEMA rbal TO acalba;
GRANT INSERT,SELECT,UPDATE,DELETE ON ALL TABLES IN SCHEMA gracethd_metis TO acalba;
GRANT ALL ON ALL TABLES IN SCHEMA ban TO acalba;
GRANT ALL ON ALL TABLES IN SCHEMA psd_orange TO acalba;
GRANT ALL ON ALL TABLES IN SCHEMA rbal TO acalba;
GRANT ALL ON ALL TABLES IN SCHEMA gracethd_metis TO acalba;
ALTER DEFAULT PRIVILEGES IN SCHEMA ban GRANT ALL PRIVILEGES ON TABLES TO acalba;
ALTER DEFAULT PRIVILEGES IN SCHEMA psd_orange GRANT ALL PRIVILEGES ON TABLES TO acalba;
ALTER DEFAULT PRIVILEGES IN SCHEMA rbal GRANT ALL PRIVILEGES ON TABLES TO acalba;
ALTER DEFAULT PRIVILEGES IN SCHEMA gracethd_metis GRANT ALL PRIVILEGES ON TABLES TO acalba;
...
GRANT CREATE ON DATABASE hsn TO acalba;
...
/*Droit d'usage de ces actions*/
GRANT USAGE ON SCHEMA ban TO acalba;
GRANT USAGE ON SCHEMA pci70_edigeo_majic TO acalba;
GRANT USAGE ON SCHEMA pci70_etalab TO acalba;
GRANT USAGE ON SCHEMA bd_routes_ign TO acalba;
GRANT USAGE ON SCHEMA psd_orange TO acalba;
GRANT USAGE ON SCHEMA topology TO acalba;
GRANT USAGE ON SCHEMA gracethd TO acalba;
GRANT USAGE ON SCHEMA gracethdcheck TO acalba;
GRANT USAGE ON SCHEMA gracethdcheckpub TO acalba;
GRANT USAGE ON SCHEMA reseau_hsn TO acalba;
GRANT USAGE ON SCHEMA enedis TO acalba;
GRANT USAGE ON SCHEMA orange TO acalba;
GRANT USAGE ON SCHEMA zone_abf TO acalba;
GRANT USAGE ON SCHEMA zone_azi TO acalba;
GRANT USAGE ON SCHEMA public TO acalba;
GRANT USAGE ON SCHEMA rbal TO acalba;
GRANT USAGE ON SCHEMA sirene TO acalba;
GRANT USAGE ON SCHEMA gracethd_metis TO acalba;
GRANT USAGE ON SCHEMA osm TO acalba;
GRANT USAGE ON SCHEMA la_poste TO acalba;
GRANT USAGE ON SCHEMA pci70_majic_analyses TO acalba;
...
GRANT USAGE ON ALL SEQUENCES IN SCHEMA ban TO acalba;
GRANT USAGE ON ALL SEQUENCES IN SCHEMA psd_orange TO acalba;
GRANT USAGE ON ALL SEQUENCES IN SCHEMA public TO acalba;
GRANT USAGE ON ALL SEQUENCES IN SCHEMA topology TO acalba;
GRANT USAGE ON ALL SEQUENCES IN SCHEMA rbal TO acalba;
GRANT USAGE ON ALL SEQUENCES IN SCHEMA gracethd_metis TO acalba;
