...
Objet : Formatage et numérotation des tables de grilles 1/2000 et 1/500 [étendue complete]
...
--- Schema : rbal
--- Table : grille_2000_polygon_2154_complet
--- Traitement : Formatage de la table grille 1/2000 

DROP TABLE IF EXISTS rbal.grille_2000_polygon_2154_complet;
CREATE TABLE rbal.grille_2000_polygon_2154_complet AS 
WITH commune AS
...
ALTER TABLE rbal.grille_2000_polygon_2154_complet  ADD PRIMARY KEY (id_grille);
CREATE INDEX grille_2000_polygon_2154_complet_gix ON rbal.grille_2000_polygon_2154_complet USING GIST (geom);


--- Schema : rbal
--- Table : grille_500_polygon_2154_complet
--- Traitement : Formatage de la table grille 1/500

DROP TABLE IF EXISTS rbal.grille_500_polygon_2154_complet;
CREATE TABLE rbal.grille_500_polygon_2154_complet AS 
WITH commune AS
-- choisi la surface maximale de commune intersectée par chaque grille
(SELECT DISTINCT ON (a.gid)
a.*,b.insee AS commune,
...
ALTER TABLE rbal.grille_500_polygon_2154_complet  ADD PRIMARY KEY (id_grille);
CREATE INDEX grille_500_polygon_2154_complet_gix ON rbal.grille_500_polygon_2154_complet USING GIST (geom);